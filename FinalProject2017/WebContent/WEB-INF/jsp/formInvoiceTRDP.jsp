...
<script>
	function validate(){
		...
		if(flag){
			...
			if(sd > ed){
				errorMessage = errorMessage + "Start Date must be later than End Date! \n";
			}
		}
		
		if(fee == ""){
			errorMessage = errorMessage + "Total Training Fee must be filled! \n";
		}
		else if(!doubleReg.test(fee)){
			errorMessage = errorMessage + "Total Training Fee must be number! \n";
		}
		else if(parseFloat(fee) <= 0){
			errorMessage = errorMessage + "Total Training Fee cannot be zero or negative! \n";	
		}
...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			...
			<div class="col-md-12" style="margin-top: 10px;">
				<div class="row">
					<div class="col-md-3"><label>Total Training Fee</label></div>
					<div class="col-md-9">
