		...
		<div id="page-wrapper" style="margin-left: 0; padding-top: 0">
		    <div class="row">
		        <div class="col-lg-12">
		            ...
		            <div class="col-lg-11">
		            	<div class="col-md-8">
				            <html:text property="newUser" name="userForm" styleClass="form-control" style="width:50%"/>
				            <button type="button" class="btn btn-primary" onclick="javascript:insertUser()">Insert New User</button>
			  			</div>
							        	...
							        	<logic:notEmpty property="userList" name="userForm">
							        		<logic:iterate id="user" property="userList" name="userForm">
							        			<tr>
									                ...
									                <td>
									                	<button type="button" class="btn btn-primary" onclick="javascript:resetPassword('<bean:write property="userName" name="user"/>')">Reset Password</button>
									                </td>
									            </tr>  
							        		</logic:iterate>
							        	</logic:notEmpty>
