...
<body>
	...
	<div id="page-wrapper">
		...
		<div class="row" style="margin-top: 1%;">
			<div class="col-lg-12">
				<label>Remaining Balance: Rp.<bean:write name="pettyCashForm" property="remainingBalance" format="#,###.00" /></label>
									...
									<logic:iterate id="pettyCash" property="transactionList" name="pettyCashForm">
										<tr>
											...
											<logic:equal value="1" name="pettyCash" property="isDebit">
												<td>Rp.<bean:write property="amount" name="pettyCash" format="#,###.00"/></td>
												<td></td>
											</logic:equal>
											...
											<td>Rp.<bean:write property="balance" name="pettyCash" format="#,###.00"/></td>
										</tr>
									</logic:iterate>
								</logic:notEmpty>
							</tbody>
