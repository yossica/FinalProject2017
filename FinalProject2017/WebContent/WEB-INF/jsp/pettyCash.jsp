	...
	<html:form action="/pettyCash" method="post">
		...
		<div id="page-wrapper">
			...
			<div class="row" style="margin-top: 1%;">
				<div class="col-lg-12">
					<label>Remaining Balance: <bean:write name="pettyCashForm"
					...
					<div class="row">
						...
						<div class="col-md-4">
							<input type="date" class="form-control" style="width: 100%;"
								...
								value="<bean:write property="filterStartDate" name="pettyCashForm" />" />
						</div>
						<div class="col-md-2">To</div>
						<div class="col-md-4">
							<input type="date" class="form-control" style="width: 100%;"
								name="filterEndDate"
								value="<bean:write property="filterEndDate" name="pettyCashForm" />" />
						</div>
					</div>
				</div>
				<div class="col-md-12"
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel-body">
						<div id="listPettyCash" class="table-responsive"
							...
							<table class="table table-hover">
								...
								<tbody>
									<logic:notEmpty property="transactionList" name="pettyCashForm">
										<logic:iterate id="pettyCash" property="transactionList"
											name="pettyCashForm">
											<tr>
												...
												<logic:equal value="1" name="pettyCash" property="isDebit">
													<td><bean:write property="amount" name="pettyCash"
															format="#,###.##" /></td>
													<td></td>
												</logic:equal>
												...
												<td><bean:write property="balance" name="pettyCash"
														format="#,###.##" /></td>
											</tr>
										</logic:iterate>
									</logic:notEmpty>
