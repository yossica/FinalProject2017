	...
	function flyToNextPage() {
		...
		if (getContractServices() == 1) {
			...
			var payment = document
					.querySelector('input[name = "paymentRadio"]:checked').value;
			if (payment == "option1") {
			...
			<div class="row">
				...
				<div class="row" style="margin-top: 10px;">
					<div class="col-md-10" style="padding-right: 1%">
						...
						<div class="col-md-8">
							<input type="date" id="invoiceDate" class="form-control-client"
								style="width: 100%;" name="invoiceBean.invoiceDate"
				...
				<div class="col-md-10" style="margin-top: 10px;">
					<div class="row">
						<div class="col-md-3">
							<label>Contract Services</label>
						</div>
						<div class="col-md-8">
							<html:select property="invoiceBean.invoiceTypeId"
								name="invoiceForm" styleClass="form-control-client"
								styleId="contractServices"
								onchange="javascript:onchangeContractServices()">
								<option selected disabled>Select</option>
								<html:optionsCollection name="invoiceForm"
									property="invoiceTypeList" label="name" value="invoiceTypeId" />
							</html:select>
						</div>
					</div>
				</div>
				<logic:notEqual property="task" name="invoiceForm"
					value="createInvoiceIndex">
					<div id="period" class="col-md-10"
						...
						<div class="row">
							...
							<div class="col-md-3">
								<html:select name="invoiceForm"
									...
									styleClass="form-control-client" styleId="periodMonth">
									<option selected disabled>Select</option>
							...
							<div class="col-md-3">
								<html:select name="invoiceForm"
									property="invoiceBean.periodYear"
									styleClass="form-control-client" styleId="periodYear">
									<option selected disabled>Select</option>
									<html:optionsCollection name="invoiceForm" property="optYear"
				...
				<logic:equal property="task" name="invoiceForm"
					value="createInvoiceIndex">
					<div id="period" class="col-md-10" style="margin-top: 10px;">
						<div class="row">
							...
							<div class="col-md-3">
								<html:select name="invoiceForm"
									property="invoiceBean.periodMonth" styleClass="form-control"
									styleId="periodMonth">
				...
				<div id="payment" class="col-md-10"
					style="margin-top: 10px; display: none;">
					<div class="row">
						<div class="col-md-3">
							<label>Payment</label>
						...
						<div class="col-md-5">
							<logic:notEqual property="task" name="invoiceForm"
								value="createInvoiceIndexTr">
								<div class="radio">
									<label> <input type="radio" name="paymentRadio"
										id="paymentOption1" value="option1"
										onchange="javascript:ifSettlement()" checked>DP
									</label> &nbsp; <label> <input type="radio" name="paymentRadio"
										id="paymentOption1" value="option2"
										onchange="javascript:ifSettlement()">Settlement
									</label>
								</div>
							</logic:notEqual>
							<logic:equal property="task" name="invoiceForm"
								...
								<div class="radio">
									<label> <input type="radio" name="paymentRadio"
										id="paymentOption1" value="option1"
										onchange="javascript:ifSettlement()">DP
									</label> &nbsp; <label> <input type="radio" name="paymentRadio"
										id="paymentOption1" value="option2"
										onchange="javascript:ifSettlement()" checked>Settlement
									</label>
								</div>
							</logic:equal>
						</div>
				...
				<div id="tax" class="col-md-10"
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="radio">
								<label> <html:radio name="invoiceForm"
										property="invoiceBean.isGross" value="0">Exclude</html:radio>
								</label> &nbsp; <label> <html:radio name="invoiceForm"
										property="invoiceBean.isGross" value="1">Include</html:radio>
								</label>
							</div>
						</div>
					</div>
				...
				<div class="col-md-12"
					...
					<button type="button" class="btn btn-primary"
						onclick="javascript:flyToPage('invoice')">Cancel</button>
					<button type="button" class="btn btn-primary"
						onclick="javascript:flyToNextPage()">Next</button>
				</div>
