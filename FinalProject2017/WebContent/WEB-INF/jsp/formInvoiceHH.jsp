					...
					<div class="col-md-12" style="margin-top: 10px;">
						<div class="row">
							...
							<div class="col-md-6">
								:
								<bean:write name="invoiceForm"
									property="invoiceBean.periodMonth" format="#" />
								/
					...
					<div class="row">
						...
						<div class="col-md-5">
							...
							<logic:equal name="invoiceForm" property="task"
								value="editInvoice">
								<html:textarea name="invoiceForm" property="invoiceBean.notes"
									styleClass="form-control" rows="3"></html:textarea>
							</logic:equal>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12" style="text-align: center;">
							<table class="table table-hover" style="width: 95%;">
								...
								<logic:iterate id="invoiceDetailHH" name="invoiceForm"
									property="headHunterList" indexId="indexHH">
									<tr>
										<td><html:text name="invoiceDetailHH"
												property="description" styleClass="form-control description"
												indexed="true"></html:text></td>
										<td><html:text name="invoiceDetailHH" property="fee"
												styleClass="form-control fee" indexed="true"></html:text></td>
										<td>
											<div class="popup">
												<span class="popuptext" id="myPopup${indexHH}"> <html:textarea
														name="invoiceDetailHH" property="notes"
														styleClass="form-control" indexed="true" rows="7"></html:textarea>
												</span>
												<button type="button" class="btn btn-primary"
													onclick="javascript:toggleNotes(${indexHH})">Notes</button>
											</div>
										</td>
										<td><logic:equal name="invoiceForm" property="task"
												value="formInvoiceHH">
												<button id="deleteButton" type="button"
													class="btn btn-primary" style="margin-bottom: 1%;"
													onclick="javascript:deleteDetailHH('${indexHH}','deleteDetailHH')">
													<i class="fa fa-times"></i>
												</button>
											</logic:equal> <logic:equal name="invoiceForm" property="task"
												value="editInvoice">
												<button id="deleteButton" type="button"
													class="btn btn-primary" style="margin-bottom: 1%;"
													onclick="javascript:deleteDetailHH('${indexHH}','deleteDetailHHonEditPage')">
													<i class="fa fa-times"></i>
												</button>
											</logic:equal></td>
									</tr>
							...
							<logic:equal name="invoiceForm" property="task"
								...
								<button type="button" class="btn btn-primary btn-circle"
									...
									onclick="javascript:flyToPage('addDetailHH')">
							...
							<logic:equal name="invoiceForm" property="task"
								...
								<button type="button" class="btn btn-primary btn-circle"
									style="margin-bottom: 1%;"
									onclick="javascript:flyToPage('editDetailHH')">
									<i class="fa fa-plus"></i>
								</button>
							</logic:equal>
						</div>
					...
					<div class="row">
						<div class="col-md-12"
							...
							<logic:equal name="invoiceForm" property="task"
								value="formInvoiceHH">
								<button type="button" class="btn btn-primary"
									onclick="javascript:flyToCancel('createInvoice')">Back</button>
								<button type="button" class="btn btn-primary"
									onclick="javascript:flyToPage('insertHH')">Save</button>
							</logic:equal>
							<logic:equal name="invoiceForm" property="task"
								value="editInvoice">
                				...
                				'<bean:write name="invoiceForm" property="statusInvoiceId" format="#"/>'
									...
									Back</button>
								<button type="button" class="btn btn-primary"
									onclick="javascript:flyToPage('editInvoiceHH')">Save</button>
							</logic:equal>
						</div>
					</div>
				</div>
