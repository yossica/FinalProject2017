...
<script>
	...
	function flyToSave() {
		...
		if (value.length > length) {
			errorMessage = errorMessage + "Length of value can't be more than "
					+ length + " ! \n";
		} else if (type == "Integer" && !intOrDouble.test(value)) {
			errorMessage = errorMessage + key + " value must be numeric ! \n";
		} else if (key == "telp" && !phoneAndFaxRegEx.test(value)
				...
				<div class="col-lg-12">
					...
					<div class="panel-body">
						...
						<div class="col-md-15" style="color: red;" id="message">
							<logic:notEmpty name="generalInformationForm"
						...
						<div class="panel-body" style="padding-left: 0;">
							<div class="pull-left">
								<button type="button" class="btn btn-primary "
									onclick="javascript:flyToPage('generalInformation')">Cancel</button>
								<button type="button" class="btn btn-primary"
