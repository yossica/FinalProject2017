...
public class TrainingManager {
	...
	public void insert(TrainingBean input) {
		...
		try {
			...
			Integer maxIdHeader = (Integer) ibatis.queryForObject(
					"training.getMaxHeaderId", null);
			if (maxIdHeader == null) {
				maxIdHeader = 1;
			} else {
				maxIdHeader++;
			...
			for (int i = 0; i < input.getDetailList().size(); i++) {
				Integer maxIdDetail = (Integer) ibatis.queryForObject(
						"training.getMaxDetailId", null);
				if (maxIdDetail == null) {
					maxIdDetail = 1;
				} else {
					maxIdDetail++;
				...
				input.getDetailList().get(i)
						.setTransactionTrainingDetailId(maxIdDetail);
				input.getDetailList().get(i)
						.setTransactionTrainingHeaderId(maxIdHeader);
				ibatis.insert("training.insertDetail", input.getDetailList()
						.get(i));
			}
	...
	public void update(TrainingBean input) {
		...
		try {
			...
			// update data detail
			for (int i = 0; i < input.getDetailList().size(); i++) {
				ibatis.insert("training.updateDetail", input.getDetailList()
						.get(i));
			}
	...
	public void resetSettlementInvoiceIdByHeaderId(Map input) {
		// kalau invoice settlement di cancel, maka perlu direset settlement
		// invoice id nya jadi 0
		SqlMapClient ibatis = IbatisHelper.getSqlMapInstance();
		try {
			ibatis.startTransaction();
	...
	public TrainingBean getById(int input) {
		...
		try {
			// get header
			result = (TrainingBean) ibatis.queryForObject("training.getById",
					input);

			// get detail
			List detailList = new ArrayList();
			detailList = ibatis.queryForList("training.getDetailByIdHeader",
					result.getTransactionTrainingHeaderId());
	...
	public Integer getHeaderIdByDpId(int input) {
		...
		SqlMapClient ibatis = IbatisHelper.getSqlMapInstance();
		try {
			result = (Integer) ibatis.queryForObject(
					"training.getHeaderIdByDpId", input);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public TrainingDetailBean getDetailById(int input) {
		...
		SqlMapClient ibatis = IbatisHelper.getSqlMapInstance();
		try {
			result = (TrainingDetailBean) ibatis.queryForObject(
					"training.getDetailById", input);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	// List detailList = new ArrayList();
	// detailList = ibatis.queryForList(
	// "training.getDetailByIdHeader", result.get(i)
	...
	public List getListedTrainingRemainderList() {
		...
		try {
			result = ibatis.queryForList(
					"training.getListedTrainingRemainderList", null);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public List getOngoingTrainingClient() {
		...
		SqlMapClient ibatis = IbatisHelper.getSqlMapInstance();
		try {
			result = ibatis.queryForList("training.getOngoingTrainingClient",
					null);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public List getOngoingTrainingByClient(int input) {
		...
		SqlMapClient ibatis = IbatisHelper.getSqlMapInstance();
		try {
			result = ibatis.queryForList("training.getOngoingTrainingByClient",
					input);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public TrainingBean getTrainingByInvoiceDpId(int input) {
		...
		SqlMapClient ibatis = IbatisHelper.getSqlMapInstance();
		try {
			result = (TrainingBean) ibatis.queryForObject(
					"training.getTrainingByInvoiceDpId", input);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public TrainingBean getTrainingByInvoiceSettlementId(int input) {
		...
		try {
			result = (TrainingBean) ibatis.queryForObject(
					"training.getTrainingByInvoiceSettlementId", input);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
