...
public class InvoiceForm extends ActionForm {
	...
	public void setProfessionalServiceList(
			List<InvoiceDetailBean> professionalServiceList) {
	...
	public void setDetailTrainingList(
			List<TrainingDetailBean> detailTrainingList) {
